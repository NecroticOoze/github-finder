      ...
      <div className="container my-3">
        ...
        <div className="card col-md-8 mx-auto p-3">
            <div className="row">
                <div className="col-md-5 text-center">
                    <img src={avatar_url} alt="Avatar" className="card-img-top rounded-circle mx-auto my-3" style={{width:"150px"}}/>
                ...
                <div className="col-md-7 my-3">
                    ...
                    <ul>
                        <li><strong>Hireable: </strong>{hireable ? <img src={Check} alt="is_hireable"/> : <img src={X} alt="is_not_hireable"/>}</li>
                        {login && <li>
        ...
        <div className="card col-md-8 mx-auto my-3 text-center p-3">
            <p className="m-0">
                ...
                <span className="badge bg-danger mx-1">Public Repos: {public_repos}</span>
                <span className="badge bg-dark mx-1">Public Gists: {public_gists}</span>
            </p>
        </div>
        <Repos repos={ repos }/>
      </div>
